...
INSERT INTO `heroes` VALUES (1,25,'Mold','M',27,4897,'Semidios',5,40.5),(2,30,'Erde','F',24,3890,'Semidiosa',4,30.2),(3,27,'Noctus','M',19,3560,'Soldado',6,12.9),(4,24,'Ravus','O',11,3717,'Mosquetero',2,27.9),(5,23,'Yuna','F',20,2033,'Invocadora',1,22.3),(6,25,'Cindy','F',23,3845,'Valquiria',3,15.8);
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='bjetos';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-11-04  0:16:14
